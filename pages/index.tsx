      ...
      <div className="bg-white flex flex-col justify-between p-6 rounded-3xl shadow-xl ">
        ...
        <ul>
          {[1, 2].map((i) => (
            <div
              key={i}
              className="flex justify-between my-2 odd:bg-blue-50 even:bg-yellow-300"
            >
        ...
        <div>
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="rounded-lg bg-blue-300 flex justify-center items-center aspect-square w-8  text-xl text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="rounded-lg bg-blue-300 flex justify-center items-center aspect-square w-8  text-xl text-gray-500">
          ...
          <div className="flex justify-between items-center ">
            ...
            <button className="bg-blue-500 px-8 py-2 text-center text-xs text-white rounded-lg">
              Add to cart
            </button>
          </div>
        </div>
